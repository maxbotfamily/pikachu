###      BROTHERHOOD BOT ලංකාවේ🇱🇰 සිංහල බොටෙක්
...
<br>
  ...
  ## BROTHERHOOD bot විශේෂාංග
BROTHERHOOD bot විශේෂාංග මෙන්න.
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=/https://github.com/maxbotfamily)
     </div>
### ⚠️ Warning! 
```
Due to Userbot; Your WhatsApp account may be banned.
